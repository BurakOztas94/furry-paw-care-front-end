    ...
    return (
        <div className="home-page">
            <h1>Welcome to Furry Paw Vet</h1>           
             ...
             Fugit impedit qui quidem harum aspernatur perferendis error iure possimus, iusto magni nesciunt, quo, recusandae fuga optio at velit? Numquam facilis fugiat id, iste dicta quis nihil inventore error consectetur.
             Asperiores qui aspernatur nulla quia iste quisquam esse ipsum unde culpa obcaecati, aut error quidem rerum dicta rem molestiae reprehenderit, excepturi repudiandae. Totam, molestias quibusdam qui velit itaque eligendi fuga.</p>
